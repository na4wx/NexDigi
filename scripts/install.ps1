...
#
# Usage: Run as Administrator: .\install.ps1
#
...
Write-Host "NexDigi Full Installation" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan
Write-Host ""
...
& $nssmExe set NexDigi DisplayName "NexDigi Packet Radio Suite"
& $nssmExe set NexDigi Description "Modern packet radio software suite with APRS, NexNet mesh, BBS, and more"
...
if ($service.Status -eq "Running") {
    ...
    Write-Host "✓ NexDigi installed successfully!" -ForegroundColor Green
    Write-Host "======================================" -ForegroundColor Green
    Write-Host ""
